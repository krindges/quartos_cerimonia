...
# Botão para resolver o problema hum
if st.button("Otimizar"):
    ...
    z = solver.IntVar(0, 1000*qtd_doces, 'z')  # Excesso de doces
    ...
    solver.Add(solver.Sum(tipo_caixas[i] * x[i] for i in range(len(tipo_caixas))) == z+qtd_doces)
